...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Ubah detail organisasi <span class="font-medium text-[#FF4400]">"{{ $organization->name }}"</span>.</p>
    </div>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        <form action="{{ route('admin.organizations.update', $organization->id) }}" method="POST" enctype="multipart/form-data" class="gap-6 flex flex-col">
            @csrf
            @method('PUT')
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                            @if ($organization->logo_url)
                                <img id="logo-preview" src="{{ asset('storage/' . $organization->logo_url) }}" alt="Preview Logo"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            logoInput.addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    logoPreview.src = '{{ $organization->logo_url ? asset("storage/" . $organization->logo_url) : "https://placehold.co/120x120?text=Preview" }}';
                }
            });
        });
    </script>
