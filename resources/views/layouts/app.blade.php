    ...
    <div class="flex h-screen">
        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-gray-800 text-white transition-all duration-300">
            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('admin.donations.index') }}" class="flex items-center px-4 py-3 hover:bg-gray-700 transition {{ request()->routeIs('admin.donations.*') ? 'bg-gray-700' : '' }}">
                    <i class="fas fa-box w-6"></i>
                    <span x-show="sidebarOpen" class="ml-3">Donasi</span>
                </a>
                <a href="{{ route('admin.donations.calendar') }}" class="flex items-center px-4 py-3 hover:bg-gray-700 transition">
