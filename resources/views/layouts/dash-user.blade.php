                        ...
                        @auth
                            <div x-data="{ userMenu: false }" class="relative">
                                <button @click="userMenu = !userMenu" @click.away="userMenu = false"
                                    ...
                                    <span
                                        class="text-gray-700 font-medium hidden sm:inline">{{ Auth::user()->profile->full_name ?? 'User' }}</span>
                            ...
                            @auth
                                <div x-data="{ userMenu: false }" class="relative">
                                    <button @click="userMenu = !userMenu" @click.away="userMenu = false"
                                        ...
                                        <span
                                            class="text-gray-700 font-medium hidden md:inline">{{ Auth::user()->profile->full_name ?? Auth::user()->email }}</span>
                                    ...
                                    <div x-show="userMenu" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        @else
                                            ...
                                            <a href="{{ route('profile.index') }}"
                                                class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                                                <i class="fas fa-user mr-3 text-[#FF4400]"></i>
                                                <span class="font-medium">Profil</span>
                                            </a>
                                            <a href="{{ route('donations.history') }}"
                                                class="flex items-center px-4 py-2.5 text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                                                <i class="fas fa-history mr-3 text-[#FF4400]"></i>
