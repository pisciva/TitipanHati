...
class DonationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $donation1 = Donation::create([
            ...
            'pickup_district' => $users[0]->profile->default_district,
        ...
        $donation2 = Donation::create([
            ...
            'pickup_district' => $users[1]->profile->default_district,
        ...
        $donation3 = Donation::create([
            ...
            'pickup_district' => $users[2]->profile->default_district,
        ...
        $donation4 = Donation::create([
            ...
            'pickup_district' => $users[3]->profile->default_district,
